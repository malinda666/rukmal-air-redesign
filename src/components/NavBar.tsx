...
const NavBar: FC = () => {
  ...
  return (
    <>
      <header className='fixed flex items-center justify-between w-full p-16 z-[9999]'>
        ...
        <div className='flex'>
          ...
          <div className='relative w-[4vw] transition-transform origin-left tr hover:scale-x-150 scale-100 mx-auto flex items-center justify-end pl-4'>
            <div
              className='relative flex flex-col items-center justify-center w-full p-2 cursor-pointer'
              aria-hidden
              onClick={() => toggleMenu()}
            >
              <span
      ...
      <nav
        className={[
          'fixed inset-0 bg-black tr transition-opacity flex flex-col items-center justify-center',
          // menuOpen
